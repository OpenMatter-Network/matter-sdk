...
<p align="center">
  <img src="assets/core-shells.svg" alt="A single pure crypto core, crates/matter-sdk-core, is shared through four bindings: native Rust, wasm-bindgen to TypeScript, a C ABI to Go, and PyO3 to Python. Every shell adds the same idiomatic committee client, quorum, Signer and call builders" width="900">
</p>
...
[`committee.rs`](../crates/matter-sdk/src/committee.rs).
...
> [`calls.rs`](../crates/matter-sdk/src/calls.rs).
...
| `crates/matter-sdk-key` | API-key ingestion + `KeySigner` — the second pure core, wasm-clean, one derivation for every binding |
