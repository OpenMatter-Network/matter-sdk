/**
 * MatterSDK core for TypeScript: seal secrets under the matter-kgc committee and
 * recover them through a signed threshold `/partial-decrypt` quorum. Crypto and
 * key derivation run in the shared wasm core.
 *
 * Keys: an {@link ApiKey} held by the SDK, or your own {@link KeySigner}/{@link Signer}
 * over an HSM, KMS, or wallet. See `docs/secure-signing.md`.
 *
 * @example
 * ```ts
 * import { ApiKey, encrypt, decrypt, FetchTransport, keySigner, Aad } from "@openmatter-network/matter-sdk-core";
 *
...
export { toHex, fromHex, secretIdToHex, wipe } from "./util.js";
