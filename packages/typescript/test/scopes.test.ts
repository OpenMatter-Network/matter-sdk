// The scope contract, replayed both ways from the fixtures Rust emits.
...
describe("ScopeSet bit layout", () => {
  ...
  it("stays unsigned across the whole range", () => {
    // JS bitwise operators are signed int32.
...
describe("requiredScopes", () => {
  ...
  it("scopes no pallet the fixture does not list", () => {
    // Unlisted pallets (token movement, staking, sudo, ...) must admit nothing.
