// Typed client failures. Branch on `kind`, never on message text.
...
export class ClientError extends Error {
  ...
  /** The key's scopes do not cover this call; raised before submission. */
  ...
  /**
   * The outer `proxy.proxy` succeeded but the wrapped call failed (reported as
   * an event, not a dispatch error).
   */
