...
// Amounts are *big.Int plancks (the chain's smallest unit), never floats: float64
// loses precision at 18 decimals and uint64 overflows. The decimal count comes
// from the live runtime; see ChainProperties.
...
func ParseAmount(text string, decimals uint8) (*big.Int, error) {
	...
	// "1." and ".5" are ambiguous; require digits on both sides of a point.
