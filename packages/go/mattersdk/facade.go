...
// SetSecretRef points a deployment at a secret, or clears it with nil.
//
...
func (f StakingFacade) BondExtra(maxAdditional *big.Int) (string, error) {
...
// Create takes no arguments: the runtime derives the org id from the signer and
// a sequence number, and create_org has no extrinsic parameters.
func (f OrgsFacade) Create() (string, error) {
