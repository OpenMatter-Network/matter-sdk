...
// Rust core (crates/matter-sdk-ffi), so this binding agrees byte-for-byte with
...
// goBytesAndFree copies an MsdkBuf into a Go slice and releases the Rust buffer.
