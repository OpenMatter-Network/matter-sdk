...
// Replays testvectors/api_keys.json: what parses, what is rejected, and which
...
const (
	...
	// Must never appear in any rendering.
...
func TestApiKeySignsAsTheClaimedAccount(t *testing.T) {
	...
	// The committee signer must advertise the same account.
