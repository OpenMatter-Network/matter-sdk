...
// Deterministic outputs must match the fixtures the Rust core generated. Requires
// the FFI staticlib:
//
...
// A symlink to the repo-root testvectors/ in the monorepo;
// scripts/assemble-go-module.sh copies the files here for the published module.
