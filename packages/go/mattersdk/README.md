...
The Go client for MatterSDK and the OpenMatter chain. See
...
over `crates/matter-sdk-ffi`, so this package agrees byte-for-byte with Rust,
...
implementation (`matter-crypto`, wrapped by `matter-sdk-core`). Re-implementing it
