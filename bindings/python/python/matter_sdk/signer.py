"""Bring-your-own-signer: the key stays behind the caller's sign function; the SDK
only frames the signature into the request's auth fields.
"""
...
class _SubstrateSigner:
    ...
    def authorize(
        ...
        # Signed per node (1-based dkg_index) so a signature cannot be replayed to a peer.
