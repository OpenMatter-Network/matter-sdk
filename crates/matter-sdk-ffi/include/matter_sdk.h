/* C ABI for MatterSDK — see crates/matter-sdk-ffi/src/lib.rs.
 *
 * Ownership: every MsdkBuf / MsdkEnvelope returned by this library was allocated by
 * Rust and MUST be released exactly once with msdk_free / msdk_envelope_free. Input
