...
///
/// # Relationship to `matter_sdk::Signer`
///
/// `matter_sdk::Signer` is *not* being replaced and is not legacy. The two
...
/// * `matter_sdk::Signer` — "here are the finished auth fields for one
