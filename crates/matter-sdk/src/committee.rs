...
//! still lives in [`matter_sdk_core`]; here we only choose a quorum, build the
...
use matter_sdk_core::{lagrange_for, open_secret, PartialInput, Plaintext};
...
/// [`matter_sdk_core::CoreError::Aead`] if the secret can't be opened at all.
