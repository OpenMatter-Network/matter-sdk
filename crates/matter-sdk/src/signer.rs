...
//!
//! * [`matter_sdk_key::KeySigner`] — "here is an account and a way to sign
...
///
/// Field meanings match [`matter_sdk_core::wire::PartialDecryptRequest`]; the
...
/// [`matter_sdk_key::KeySigner`] instead and let [`partial_decrypt_auth`] do
...
mod tests {
    ...
    /// `crates/matter-sdk-key/tests/parse.rs` and every binding.
